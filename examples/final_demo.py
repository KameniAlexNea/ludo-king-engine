...
def main():
    ...
    for strategy in strategies:
        print(
            f"  ✓ {strategy.capitalize()}: {strategy_info.get(strategy, 'No description')}"
        )
    ...
    tournament = utils.run_strategy_tournament(
        tournament_strategies, rounds=2, games_per_round=3
    )
    ...
    print("  Core modules: Board, Token, Player, Game")
    print("  Utility functions: Analysis, Tournament, Export/Import")
