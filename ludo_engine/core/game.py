...
class LudoGame:
    ...
    def __init__(self, player_colors: List[str] = None, strategies: List[str] = None, seed: Optional[int] = None):
        """
    ...
    def _create_players(self, colors: List[str], strategy_names: List[str]) -> List[Player]:
    ...
    def __repr__(self) -> str:
        ...
        return (f"LudoGame(players={len(self.players)}, "
